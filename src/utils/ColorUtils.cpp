...
namespace ColorUtils
{
    ...
    void HsvToBLRgba32(const HsvColor &hsv_color, BLRgba32 &rgba)
    {
        ...
        else
        {
            ...
            default:
                ...
                g_f = p;
                b_f = q;
                break; // Handles sector 5 and h_sector close to 6.0
            }
        }
    ...
    {
        if (totalLayers <= 0)
            return baseColor; // Should not happen
