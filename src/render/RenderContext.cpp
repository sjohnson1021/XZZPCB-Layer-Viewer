...
void RenderContext::Shutdown()
{
    ...
    { // Check if context is active before ending
        m_blContext.end();
    }
...
void RenderContext::SetBoardDataManager(std::shared_ptr<BoardDataManager> boardDataManager)
{
